...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Live Demo
      link: https://felipecarrillo100.github.io/react-dockable-desktop/demo/
      target: _blank
    - theme: alt
      text: View on GitHub
      link: https://github.com/felipecarrillo100/react-dockable-desktop
      target: _blank

features:
  - icon: 📦
    title: Dockable Splits & Tabs
    details: Drag panels to split screens or group them into tabbed containers. Full tree-based layout engine with serialization.
  - icon: 🔬
    title: Zero-Unmount DOM Preservation
  ...
  - icon: 🌍
    ...
    details: Full Right-to-Left layout support (Arabic, Hebrew, Persian). Set dir="rtl" on the provider — every control, tab, drop zone and menu of the workspace flips automatically; the sidebar and toasts follow the page's dir.
  - icon: 🔌
